...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "I work with a maximum of twelve client mandates per quarter — not because of capacity constraints, but because due diligence done properly takes time, and I sign off personally on every purchase." },
      { type: "paragraph", text: "In 2026, I am directing clients toward off-market first-line opportunities in Gonio and Makhinjauri (pre-public pricing, 15–20% below comparable listed assets), branded residence projects with proven management operators, and second-line Batumi assets in the $80,000–120,000 range for yield-focused investors. What I am avoiding: mid-tier projects in oversupplied New Boulevard micro-locations, developers with unresolved litigation, and anything with land lease rather than freehold title." },
      { type: "paragraph", text: "If you are considering a Batumi investment in 2026, the single most valuable thing you can do is talk to someone who has closed transactions in the last 90 days — not someone working from a 2024 market report. I offer a free 30-minute strategy call. No catalog, no pressure." },
    ],
  },
];
