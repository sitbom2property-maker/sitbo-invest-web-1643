...
{/* Left: text */}
        <div style={{ flex: "1 1 0", minWidth: 0 }}>
          <h1 style={{ fontFamily: "JUN, Georgia, serif", fontSize: "clamp(2.8rem,5vw,5.5rem)", fontWeight: 400, color: C.light, lineHeight: 1.05, marginBottom: "28px" }}>
            {t("turnkey.hero.title")}<br />
            <em style={{ fontStyle: "italic", color: C.light }}>{t("turnkey.hero.titleEm")}</em>
          </h1>

          <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "clamp(0.9rem,1.3vw,1.05rem)", color: C.light, lineHeight: 1.75, marginBottom: "52px" }}>
            {t("turnkey.hero.body")}
          </p>

          <div style={{ display: "flex", gap: "14px", flexWrap: "wrap" }}>
            <a href="#contact-form" style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.78rem", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: C.light, background: C.teal, borderRadius: "8px", padding: "16px 36px", textDecoration: "none", transition: "opacity 0.2s" }} onMouseEnter={e => (e.currentTarget.style.opacity = "0.85")} onMouseLeave={e => (e.currentTarget.style.opacity = "1")}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "10px" }}>
        {cols.map(col => (
          <div key={col.tag} style={{ background: col.bg, borderRadius: "10px", padding: "clamp(48px,5vw,72px) clamp(32px,4vw,56px)" }}>
            <h2 style={{ fontFamily: "JUN, Georgia, serif", fontSize: "clamp(1.8rem,3vw,2.6rem)", fontWeight: 400, color: col.dark ? C.light : C.dark, lineHeight: 1.15, marginBottom: "20px" }}>{col.title}</h2>
            <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.88rem", color: col.dark ? C.light : "rgba(33,20,26,0.55)", lineHeight: 1.8, marginBottom: "40px" }}>{col.text}</p>
            <div style={{ display: "flex", flexDirection: "column", gap: "28px" }}>
              {col.items.map(item => (
                <div key={item.label} style={{ display: "flex", gap: "16px", alignItems: "flex-start" }}>
                  ...
                  <div>
                    <p style={{ fontFamily: "Nunito, sans-serif", fontWeight: 700, fontSize: "0.85rem", color: col.dark ? C.light : C.dark, margin: "0 0 5px" }}>{item.label}</p>
                    <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.8rem", color: col.dark ? C.light : "rgba(33,20,26,0.5)", lineHeight: 1.65, margin: 0 }}>{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
            <div style={{ marginTop: "40px" }}>
              <a href="#contact-form" style={{ display: "inline-block", fontFamily: "Nunito, sans-serif", fontSize: "0.72rem", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: C.light, background: col.dark ? C.teal : C.dark, borderRadius: "8px", padding: "12px 28px", textDecoration: "none", transition: "opacity 0.2s" }} onMouseEnter={e => (e.currentTarget.style.opacity = "0.8")} onMouseLeave={e => (e.currentTarget.style.opacity = "1")}>
  ...
  return (<>
    ...
    <section style={{ background: C.dark, padding: "10px" }}>
      <div style={{ background: C.wine, borderRadius: "10px", padding: "clamp(60px,7vw,100px) clamp(32px,5vw,80px)", textAlign: "center", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", fontSize: "clamp(80px,20vw,220px)", fontFamily: "Nunito, sans-serif", fontWeight: 700, color: "rgba(255,254,249,0.05)", lineHeight: 1, userSelect: "none", pointerEvents: "none", whiteSpace: "nowrap" }}>100%</div>
        <div style={{ position: "relative", zIndex: 1, maxWidth: "720px", margin: "0 auto" }}>
          <h2 style={{ fontFamily: "JUN, Georgia, serif", fontSize: "clamp(2rem,4vw,3.2rem)", fontWeight: 400, color: C.light, lineHeight: 1.15, marginBottom: "28px" }}>
            {t("turnkey.design.title")}<br />
            <em style={{ fontStyle: "italic" }}>{t("turnkey.design.titleEm")}</em>
          </h2>
          <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.9rem", color: C.light, lineHeight: 1.8, marginBottom: "12px" }}>
            {t("turnkey.design.body1")}
          </p>
          <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.9rem", color: C.light, lineHeight: 1.8 }}>
...
function Calculator() {
  ...
  const Radio = ({ name, value, current, label, onChange }: { name: string; value: string; current: string; label: string; onChange: (v: string) => void }) => (
    <label style={{ display: "flex", alignItems: "center", gap: "10px", cursor: "pointer", fontFamily: "Nunito, sans-serif", fontSize: "0.85rem", color: current === value ? C.dark : "rgba(33,20,26,0.5)", fontWeight: current === value ? 600 : 400, transition: "color 0.2s" }}>
    ...
    <section style={{ background: C.dark, padding: "10px" }}>
      <div style={{ background: C.light, borderRadius: "10px", padding: "clamp(48px,6vw,80px) clamp(24px,4vw,64px)" }}>
        <div style={{ maxWidth: "800px", margin: "0 auto" }}>
          <h2 style={{ fontFamily: "JUN, Georgia, serif", fontSize: "clamp(2rem,3.5vw,2.8rem)", fontWeight: 400, color: C.dark, lineHeight: 1.1, marginBottom: "10px" }}>
            {t("turnkey.calculator.title")}
          </h2>
          <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.85rem", color: C.muted, lineHeight: 1.7, marginBottom: "40px" }}>
...
{/* Area slider */}
          <div style={{ marginBottom: "36px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "10px" }}>
              <span style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.75rem", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.1em", color: C.dark }}>{t("turnkey.calculator.area")}</span>
              <span style={{ fontFamily: "Nunito, sans-serif", fontSize: "1.4rem", fontWeight: 700, color: C.dark }}>{area} m²</span>
            </div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginTop: "4px" }}>
              <span style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.65rem", color: "rgba(33,20,26,0.4)" }}>25 m²</span>
              <span style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.65rem", color: "rgba(33,20,26,0.4)" }}>200 m²</span>
            </div>
          </div>

          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "32px", marginBottom: "36px" }}>
            <div>
              <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.75rem", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.1em", color: C.dark, marginBottom: "14px" }}>{t("turnkey.calculator.condition")}</p>
            ...
            <div>
              <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.75rem", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.1em", color: C.dark, marginBottom: "14px" }}>{t("turnkey.calculator.goal")}</p>
              <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            ...
            <div>
              <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.75rem", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.1em", color: C.dark, marginBottom: "14px" }}>{t("turnkey.calculator.finish")}</p>
              <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          ...
          {shown && (
            <div style={{ marginTop: "28px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
              <div style={{ background: C.dark, borderRadius: "10px", padding: "28px 24px", textAlign: "center" }}>
                <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.6rem", letterSpacing: "0.16em", textTransform: "uppercase", color: C.light, marginBottom: "10px" }}>{t("turnkey.calculator.costRange")}</p>
                <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "2rem", fontWeight: 700, color: C.light, margin: 0 }}>
                  ${low.toLocaleString()} – ${high.toLocaleString()}
                </p>
              </div>
              <div style={{ background: C.wine, borderRadius: "10px", padding: "28px 24px", textAlign: "center" }}>
                <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.6rem", letterSpacing: "0.16em", textTransform: "uppercase", color: C.light, marginBottom: "10px" }}>{t("turnkey.calculator.timeline")}</p>
                <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "2rem", fontWeight: 700, color: C.light, margin: 0 }}>{timeline}</p>
              </div>
              <div style={{ gridColumn: "1 / -1" }}>
                <a href="#contact-form" style={{ display: "block", textAlign: "center", fontFamily: "Nunito, sans-serif", fontSize: "0.78rem", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: C.light, background: C.teal, borderRadius: "10px", padding: "16px", textDecoration: "none", transition: "opacity 0.2s" }} onMouseEnter={e => (e.currentTarget.style.opacity = "0.85")} onMouseLeave={e => (e.currentTarget.style.opacity = "1")}>
      ...
      <div style={{ background: C.light, borderRadius: "10px", padding: "clamp(60px,7vw,100px) clamp(24px,4vw,64px)" }}>
        <div style={{ maxWidth: "var(--site-max)", margin: "0 auto", padding: "0 var(--site-gutter)" }}>
          <div style={{ textAlign: "center", marginBottom: "64px" }}>
            <h2 style={{ fontFamily: "JUN, Georgia, serif", fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 400, color: C.dark, lineHeight: 1.1 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "2px", borderRadius: "10px", overflow: "hidden" }}>
            {steps.map((s, i) => (
              <div key={s.n} style={{ background: i % 2 === 0 ? C.parch : "#FFFEF9", padding: "40px 32px" }}>
                <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "2.8rem", fontWeight: 700, color: "rgba(33,20,26,0.1)", margin: "0 0 20px", lineHeight: 1 }}>{s.n}</p>
                <p style={{ fontFamily: "Nunito, sans-serif", fontWeight: 700, fontSize: "0.88rem", color: C.dark, margin: "0 0 10px" }}>{s.title}</p>
                <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.82rem", color: "rgba(33,20,26,0.5)", lineHeight: 1.7, margin: 0 }}>{s.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div style={{ background: C.dark, borderRadius: "10px", padding: "clamp(60px,7vw,100px) clamp(24px,4vw,64px)" }}>
        <div style={{ maxWidth: "var(--site-max)", margin: "0 auto", padding: "0 var(--site-gutter)" }}>
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: "24px", marginBottom: "48px" }}>
            <div>
              <h2 style={{ fontFamily: "JUN, Georgia, serif", fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 400, color: C.light, lineHeight: 1.1 }}>
...
{([["all", t("turnkey.portfolio.all")], ["life", t("turnkey.portfolio.forLife")], ["invest", t("turnkey.portfolio.forInvestment")]] as const).map(([val, label]) => (
                <button key={val} onClick={() => setFilter(val)} style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.7rem", fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", border: "none", borderRadius: "7px", padding: "9px 18px", cursor: "pointer", transition: "all 0.2s", background: filter === val ? C.teal : "transparent", color: C.light }}>
{label}
                </button>
              ))}
            </div>
            ...
            {visible.map((p, i) => (
              <div key={p.title} style={{ borderRadius: "10px", overflow: "hidden", background: placeholderColors[i % placeholderColors.length] + "33", border: "1px solid rgba(255,254,249,0.06)" }}>
                ...
                <div style={{ padding: "24px" }}>
                  <h3 style={{ fontFamily: "JUN, Georgia, serif", fontSize: "1.2rem", fontWeight: 500, color: C.light, margin: "0 0 14px" }}>{p.title}</h3>
                  <div style={{ display: "flex", flexWrap: "wrap", gap: "6px" }}>
                    {p.tags.map(tag => (
                      <span key={tag} style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.62rem", letterSpacing: "0.08em", textTransform: "uppercase", color: C.light, background: p.type === "invest" ? "rgba(140,178,192,0.1)" : "rgba(255,254,249,0.06)", borderRadius: "4px", padding: "4px 8px" }}>{tag}</span>
                    ))}
                  </div>
                </div>
              </div>
    ...
    <section style={{ background: C.dark, padding: "10px" }}>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "10px" }}>
        <div style={{ background: C.light, borderRadius: "10px", padding: "clamp(48px,5vw,64px) clamp(32px,4vw,48px)" }}>
          <h3 style={{ fontFamily: "JUN, Georgia, serif", fontSize: "clamp(1.6rem,2.5vw,2.2rem)", fontWeight: 400, color: C.dark, lineHeight: 1.2, marginBottom: "20px" }}>
            {t("turnkey.guarantee.self.title")}
          </h3>
          <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.88rem", color: "rgba(33,20,26,0.55)", lineHeight: 1.8 }}>
        ...
        <div style={{ background: C.dark, border: "1px solid rgba(140,178,192,0.1)", borderRadius: "10px", padding: "clamp(48px,5vw,64px) clamp(32px,4vw,48px)" }}>
          <h3 style={{ fontFamily: "JUN, Georgia, serif", fontSize: "clamp(1.6rem,2.5vw,2.2rem)", fontWeight: 400, color: C.light, lineHeight: 1.2, marginBottom: "20px" }}>
            {t("turnkey.guarantee.invest.title")}
          </h3>
          <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.88rem", color: C.light, lineHeight: 1.8 }}>
...
function MarketStats() {
  ...
  return (<>
    ...
    <section style={{ background: C.dark, padding: "80px 10px" }}>
      <div style={{ maxWidth: "var(--site-max)", margin: "0 auto", padding: "0 var(--site-gutter)" }}>
        <h2 style={{ fontFamily: "JUN, Georgia, serif", fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 400, color: C.light, lineHeight: 1.1, marginBottom: "60px", maxWidth: "700px" }}>
...
{/* Stat 1: Tourism Growth */}
          <div>
            <div style={{ marginBottom: "16px" }}>
              <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "2.8rem", fontWeight: 700, color: C.light, margin: "0" }}>9,4M</p>
              <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.8rem", color: C.light, margin: "6px 0 0", letterSpacing: "0.08em", textTransform: "uppercase" }}>{t("turnkey.market.stat1.label")}</p>
            </div>
            <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.9rem", color: C.light, lineHeight: 1.7, margin: 0 }}>
...
{/* Stat 2: Nightly Rates */}
          <div>
            <div style={{ marginBottom: "16px" }}>
              <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "2.8rem", fontWeight: 700, color: C.light, margin: "0" }}>$60–$100</p>
              <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.8rem", color: C.light, margin: "6px 0 0", letterSpacing: "0.08em", textTransform: "uppercase" }}>{t("turnkey.market.stat2.label")}</p>
            </div>
            <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.9rem", color: C.light, lineHeight: 1.7, margin: 0 }}>
...
{/* Stat 3: Payback Period */}
          <div>
            <div style={{ marginBottom: "16px" }}>
              <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "2.8rem", fontWeight: 700, color: C.light, margin: "0" }}>11</p>
              <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.8rem", color: C.light, margin: "6px 0 0", letterSpacing: "0.08em", textTransform: "uppercase" }}>{t("turnkey.market.stat3.label")}</p>
            </div>
            <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.9rem", color: C.light, lineHeight: 1.7, margin: 0 }}>
...
{/* Stat 4: Price Appreciation */}
          <div>
            <div style={{ marginBottom: "16px" }}>
              <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "2.8rem", fontWeight: 700, color: C.light, margin: "0" }}>+70%</p>
              <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.8rem", color: C.light, margin: "6px 0 0", letterSpacing: "0.08em", textTransform: "uppercase" }}>{t("turnkey.market.stat4.label")}</p>
            </div>
            <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.9rem", color: C.light, lineHeight: 1.7, margin: 0 }}>
...
{/* Stat 5: Market Price */}
          <div>
            <div style={{ marginBottom: "16px" }}>
              <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "2.8rem", fontWeight: 700, color: C.light, margin: "0" }}>$1,850</p>
              <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.8rem", color: C.light, margin: "6px 0 0", letterSpacing: "0.08em", textTransform: "uppercase" }}>{t("turnkey.market.stat5.label")}</p>
            </div>
            <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.9rem", color: C.light, lineHeight: 1.7, margin: 0 }}>
...
{/* Stat 6: Institutional Confidence */}
          <div>
            <div style={{ marginBottom: "16px" }}>
              <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "2.8rem", fontWeight: 700, color: C.light, margin: "0" }}>✓</p>
              <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.8rem", color: C.light, margin: "6px 0 0", letterSpacing: "0.08em", textTransform: "uppercase" }}>{t("turnkey.market.stat6.label")}</p>
            </div>
            <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.9rem", color: C.light, lineHeight: 1.7, margin: 0 }}>
...
function ContactForm() {
  ...
  const inputStyle: CSSProperties = {
    ...
    borderRadius: "8px", padding: "14px 16px", color: C.light, fontFamily: "Nunito, sans-serif",
    fontSize: "0.88rem", outline: "none", boxSizing: "border-box", transition: "border-color 0.2s",
  };
  const labelStyle: CSSProperties = {
    display: "block", fontFamily: "Nunito, sans-serif", fontSize: "0.65rem", letterSpacing: "0.14em",
  ...
  return (<>
    ...
    <section id="contact-form" style={{ background: C.dark, padding: "10px 10px 0" }}>
      <div style={{ background: C.dark, borderRadius: "10px 10px 0 0", padding: "clamp(60px,8vw,120px) clamp(24px,4vw,64px)" }}>
        <div style={{ maxWidth: "680px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "52px" }}>
            <h2 style={{ fontFamily: "JUN, Georgia, serif", fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 400, color: C.light, lineHeight: 1.1, marginBottom: "16px" }}>
              {t("turnkey.contact.title")}
            </h2>
            <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.88rem", color: C.light, lineHeight: 1.75 }}>
          ...
          {sent ? (
            <div style={{ textAlign: "center", padding: "60px 0" }}>
              ...
              <h2 style={{ fontFamily: "JUN, Georgia, serif", fontSize: "1.8rem", fontWeight: 400, color: C.light, marginBottom: "10px" }}>{t("turnkey.contact.successTitle")}</h2>
              <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.85rem", color: C.light }}>{t("turnkey.contact.successBody")}</p>
            </div>
          ) : (
...
{/* Contact details */}
          <div style={{ marginTop: "48px", paddingTop: "40px", borderTop: "1px solid rgba(140,178,192,0.1)", display: "flex", justifyContent: "center", flexWrap: "wrap", gap: "32px" }}>
            <a href="https://wa.me/995591800800" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: "8px", fontFamily: "Nunito, sans-serif", fontSize: "0.8rem", color: C.light, textDecoration: "none" }}>
            ...
            <a href="mailto:sitboinvest@gmail.com" style={{ display: "flex", alignItems: "center", gap: "8px", fontFamily: "Nunito, sans-serif", fontSize: "0.8rem", color: C.light, textDecoration: "none" }}>
            ...
            <span style={{ display: "flex", alignItems: "center", gap: "8px", fontFamily: "Nunito, sans-serif", fontSize: "0.8rem", color: C.light }}>
