...
function TRow({ label, value }: { label: string; value: string }) {
  return (<>
    ...
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "16px", padding: "11px 0", borderBottom: "1px solid rgba(33,20,26,0.07)" }}>
      <span style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.83rem", color: C.muted }}>{label}</span>
      <span style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.83rem", color: C.dark, fontWeight: 600, textAlign: "right" }}>{value}</span>
    </div>
  ...
  return (
    <div className="m-reveal" style={{ transitionDelay: `${delay}ms`, display: "flex", gap: "20px", padding: "28px 0", borderBottom: "1px solid rgba(33,20,26,0.07)", flex: 1 }}>
      <div style={{ flexShrink: 0, width: "44px", height: "44px", borderRadius: "50%", border: `1.5px solid ${C.wine}`, display: "flex", alignItems: "center", justifyContent: "center" }}>
        <span style={{ fontFamily: "Nunito, sans-serif", fontSize: "1rem", fontWeight: 700, color: C.wine }}>{String(n).padStart(2, "0")}</span>
      </div>
      <div style={{ paddingTop: "8px" }}>
        <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.9rem", fontWeight: 700, color: C.dark, marginBottom: "6px" }}>{title}</p>
        <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.83rem", color: C.muted, lineHeight: 1.7, margin: 0 }}>{desc}</p>
      </div>
    </div>
  );
}
...
function MortgageCalculator() {
  ...
  const fieldLabel: React.CSSProperties = {
    display: "block", fontFamily: "Nunito, sans-serif", fontSize: "0.72rem",
  ...
  const numInput: React.CSSProperties = {
    ...
    padding: "10px 14px", fontFamily: "Nunito, sans-serif", fontSize: "0.88rem", color: C.dark,
        ...
        <Row style={{ marginBottom: "48px" }}>
          <Col span={6}>
            <div className="m-reveal">
              <h2 style={{ fontFamily: "JUN, Georgia, serif", fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 400, color: C.dark, lineHeight: 1.15 }}>
          ...
          <Col span={6}>
            <div className="m-reveal" style={{ transitionDelay: "80ms", paddingTop: "20px" }}>
              <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.88rem", color: C.muted, lineHeight: 1.8 }}>
    ...
    { label: t("mortgage.calculator.totalCost"), value: fmt(totalPaid + downAmount), accent: false },
            ...
            <Col key={item.label} span={3}>
              <div className="m-reveal" style={{
                ...
                <div style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.68rem", letterSpacing: "0.12em", textTransform: "uppercase", color: item.accent ? C.light : C.muted }}>
                  {item.label}
                </div>
              </div>
            </Col>
        ...
        <Row style={{ marginTop: "16px" }}>
          <Col span={12}>
            <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.72rem", color: C.muted, margin: 0, lineHeight: 1.6 }}>
          ...
          <Row style={{ minHeight: "80vh", alignItems: "center", paddingTop: "48px", paddingBottom: "64px" }}>
            ...
            <Col span={7}>
              <div className="m-reveal">
                ...
                <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "clamp(0.9rem,1.8vw,1.05rem)", color: C.muted, lineHeight: 1.8, maxWidth: "480px", marginBottom: "40px" }}>
                  {t("mortgage.hero.body")}
                </p>
                <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
                  <a href="#calculator" style={{ display: "inline-block", fontFamily: "Nunito, sans-serif", fontSize: "0.78rem", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: C.light, background: C.dark, borderRadius: "8px", padding: "14px 32px", textDecoration: "none" }}>
                    {t("mortgage.hero.ctaCalculator")}
                  </a>
                  <a href="#terms" style={{ display: "inline-block", fontFamily: "Nunito, sans-serif", fontSize: "0.78rem", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: C.dark, background: "transparent", border: `1px solid ${C.dark}`, borderRadius: "8px", padding: "14px 32px", textDecoration: "none" }}>
...
{/* Right: key stats */}
    ...
    { val: "$500K", label: t("mortgage.stat.maxAmount") },
                    ...
                    <div key={s.label} style={{ background: C.light, borderRadius: "10px", padding: "24px 20px", borderTop: `2px solid ${C.wine}` }}>
                      <div style={{ fontFamily: "Nunito, sans-serif", fontSize: "1.8rem", fontWeight: 700, color: C.dark, lineHeight: 1, marginBottom: "6px" }}>{s.val}</div>
                      <div style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.72rem", color: C.muted, letterSpacing: "0.08em", textTransform: "uppercase" }}>{s.label}</div>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section id="terms" style={{ padding: "96px 0" }}>
        <Container>
          <Row style={{ marginBottom: "56px" }}>
            <Col span={5}>
              <div className="m-reveal">
                <h2 style={{ fontFamily: "JUN, Georgia, serif", fontSize: "clamp(2rem,4vw,3.2rem)", fontWeight: 400, color: C.dark, lineHeight: 1.15 }}>
            ...
            <Col span={7}>
              <div className="m-reveal" style={{ transitionDelay: "80ms", paddingTop: "20px" }}>
                <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.95rem", color: C.muted, lineHeight: 1.8 }}>
...
{/* Card 1: Down Payment */}
            <Col span={6}>
              <div className="m-reveal" style={{ background: C.light, borderRadius: "10px", padding: "32px 28px", height: "100%", boxSizing: "border-box" }}>
                <h3 style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.72rem", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: C.wine, marginBottom: "20px" }}>{t("mortgage.terms.downPayment.title")}</h3>
                <div style={{ fontFamily: "Nunito, sans-serif", fontSize: "3.5rem", fontWeight: 700, color: C.dark, lineHeight: 1, marginBottom: "8px" }}>30–40%</div>
                <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.83rem", color: C.muted, lineHeight: 1.7, marginBottom: "16px" }}>
                ...
                <div style={{ background: C.light, borderRadius: "8px", padding: "14px 16px", display: "flex", alignItems: "center", gap: "10px" }}>
                  ...
                  <span style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.8rem", color: C.mutedDark }}>
...
{/* Card 2: Rates */}
            <Col span={6}>
              <div className="m-reveal" style={{ transitionDelay: "80ms", background: C.light, border: "1px solid rgba(33,20,26,0.08)", borderRadius: "10px", padding: "32px 28px", height: "100%", boxSizing: "border-box" }}>
                <h3 style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.72rem", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: C.wine, marginBottom: "20px" }}>{t("mortgage.terms.rates.title")}</h3>
                ...
                <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.75rem", color: C.muted, marginTop: "14px", lineHeight: 1.6 }}>
...
{/* Card 3: Loan params */}
            <Col span={4}>
              <div className="m-reveal" style={{ transitionDelay: "40ms", background: C.light, border: "1px solid rgba(33,20,26,0.08)", borderRadius: "10px", padding: "28px 24px" }}>
                <h3 style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.72rem", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: C.wine, marginBottom: "16px" }}>{t("mortgage.terms.loanParameters")}</h3>
...
{/* Card 4: Who qualifies */}
            <Col span={8}>
              <div className="m-reveal" style={{ transitionDelay: "80ms", background: C.dark, borderRadius: "10px", padding: "28px 28px" }}>
                <h3 style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.72rem", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: C.light, marginBottom: "16px" }}>{t("mortgage.terms.whoQualifies")}</h3>
                <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.88rem", color: C.light, lineHeight: 1.7, marginBottom: "20px" }}>
...
{[
  ...
  t("mortgage.terms.qualification.dividends"),
                    ...
                    <div key={item} style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                      ...
                      <span style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.8rem", color: C.light }}>{item}</span>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section style={{ padding: "80px 0", background: C.light }}>
        <Container>
          <Row style={{ marginBottom: "48px" }}>
            <Col span={5}>
              <div className="m-reveal">
                <h2 style={{ fontFamily: "JUN, Georgia, serif", fontSize: "clamp(1.8rem,3.5vw,3rem)", fontWeight: 400, color: C.dark, lineHeight: 1.2 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "20px", alignItems: "stretch" }}>
            {[
              ...
              <div key={item.title} className="m-reveal" style={{
                ...
                <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.88rem", fontWeight: 700, color: C.dark, marginBottom: "8px" }}>{item.title}</p>
                <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.8rem", color: C.muted, lineHeight: 1.6, margin: 0 }}>{item.desc}</p>
              </div>
            ))}
          </div>
        </Container>
        ...
        <Container>
          <Row>
            <Col span={8} style={{ margin: "0 auto", textAlign: "center" }}>
              <div className="m-reveal">
                <h2 style={{ fontFamily: "JUN, Georgia, serif", fontSize: "clamp(2rem,5vw,3.6rem)", fontWeight: 400, color: C.light, lineHeight: 1.1, marginBottom: "20px" }}>
                  {t("mortgage.cta.title")}
                </h2>
                <p style={{ fontFamily: "Nunito, sans-serif", fontSize: "0.92rem", color: C.light, lineHeight: 1.7, maxWidth: "480px", margin: "0 auto 40px" }}>
                  {t("mortgage.cta.body")}
                </p>
                <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
                  <AppLink href="/#contact" style={{ display: "inline-block", fontFamily: "Nunito, sans-serif", fontSize: "0.78rem", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: C.light, background: C.teal, borderRadius: "8px", padding: "15px 36px", textDecoration: "none" }}>
                    {t("cta.getFreeConsultation")}
                  </AppLink>
                  <a href="https://wa.me/995555505288" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", fontFamily: "Nunito, sans-serif", fontSize: "0.78rem", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: C.light, background: "transparent", border: "1px solid rgba(255,254,249,0.2)", borderRadius: "8px", padding: "15px 36px", textDecoration: "none" }}>
                    {t("cta.whatsappUs")}
                  </a>
                </div>
              </div>
