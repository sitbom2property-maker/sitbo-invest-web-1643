        ...
        <Container style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <Link href="/">
            <a style={{ display: "flex", alignItems: "center", textDecoration: "none" }}>
              <img src="/logo-light-bg.png" alt="SITBO" style={{ height: "19px", width: "auto", objectFit: "contain" }} />
            </a>
          </Link>
...
{!isMobile && (
              <>
                ...
                <a href="#process" style={{ fontFamily: "DM Sans", fontSize: "0.75rem", letterSpacing: "0.08em", textTransform: "uppercase", color: C.muted, textDecoration: "none" }}>How It Works</a>
              </>
            )}
            <Link href="/#contact">
              <a style={{
                fontFamily: "DM Sans", fontSize: "0.72rem", fontWeight: 600, letterSpacing: "0.1em",
                textTransform: "uppercase", color: C.light, background: C.dark,
                borderRadius: "6px", padding: "9px 20px", textDecoration: "none",
              }}>
                Get Started
              </a>
            </Link>
