const en = {
  ...
  "services.item1.bullet1": "Title history and ownership chain verification",
  "services.item1.bullet2": "Developer track record: completed projects, delivery timelines, litigation history",
  "services.item1.bullet3": "Land plot category, encumbrances, and master plan compliance",
  "services.item1.bullet4": "Contract review: flagging dangerous clauses, requiring amendments before signing",
  "services.item1.bullet5": "Written due diligence report delivered to the client (3–5 pages)",
  ...
  "services.item2.bullet1": "Goal mapping: rental income / resale / residency / capital preservation",
  "services.item2.bullet2":
    "District comparison: Batumi centre, Gonio, Chakvi, Makhinjauri — yield vs risk vs liquidity",
  "services.item2.bullet3": "Access to off-market and first-release developer inventory only",
  "services.item2.bullet4": "ROI model per object: conservative, base, and optimistic scenarios",
  "services.item2.bullet5": "Capacity: twelve client mandates per quarter — your case receives full attention",
  ...
  "services.item3.bullet1": "Design concept tailored to target tenant profile (tourists, expats, long-term)",
  "services.item3.bullet2": "Detailed cost estimate provided before work begins",
  "services.item3.bullet3": "Weekly photo progress reports sent to the client",
  "services.item3.bullet4": "Full furnishing and fit-out included — ready to occupy on handover",
  ...
  "services.item4.bullet1": "Bank selection: TBC Bank, Bank of Georgia, Credo Bank",
  "services.item4.bullet2": "Programme matching for non-resident buyers — a distinct expertise",
  "services.item4.bullet3": "Rate, deposit, and term negotiation on behalf of the client",
  "services.item4.bullet4": "Full documentation support for the bank submission process",
  "services.item4.bullet5": "We represent the client's interest exclusively",
  ...
  "services.item5.bullet1": "Properties shown: due diligence completed before your arrival",
  "services.item5.bullet2": "Meetings arranged: legal counsel, notary, developer where relevant",
  "services.item5.bullet3": "Transfer, accommodation, and programme logistics handled in full",
  "services.item5.bullet4": "Format: a working session with a decision outcome — not a sightseeing tour",
  ...
  "services.item6.bullet1": "Rental strategy: short-term (Airbnb / Booking) or long-term — client's choice",
  "services.item6.bullet2": "Management model selection: in-house oversight or management company",
  "services.item6.bullet3": "Monthly statement: occupancy, revenue, and operating costs",
  "services.item6.bullet4": "Maintenance coordination and tenant issue resolution",
  "services.item6.bullet5": "Designed for non-resident owners who require full hands-off operation",
  ...
  "services.item7.bullet3": "Georgian bank account opening — before and after purchase",
  "services.item7.bullet4": "Company registration in Georgia for relocating business owners",
  "services.item7.bullet5": "Verified referral network: legal, accounting, and tax advisory partners",
