const en = {
  ...
  "v2.footer.tagline":
    "Arthur is your personal real estate advisor in Georgia, born and raised locally with 7 years of experience in Batumi. Dedicated to protecting and growing your capital, selecting only liquid properties, and eliminating risks and emotions. Full-cycle service in the buyer’s interest — from due diligence to turnkey renovation, building long-term relationships.",
  ...
  "catalog.allocation.trophy": "Trophy property",
  "catalog.allocation.income": "Guaranteed income",
  "catalog.allocation.residence": "Residences",
  "catalog.badge.trophy": "Trophy",
  "catalog.badge.income": "Income",
  ...
  "catalog.city.pasanauri": "Pasanauri",
  "catalog.roi": "ROI",
  "catalog.guaranteed": "guaranteed",
  ...
  "project.guaranteedYield": "Guaranteed income",
  "project.realYield": "Hotel management",
  "project.buyback": "Buy-back",
  "project.income.title": "Guaranteed income",
  "project.income.body":
    "Contractual yield is fixed in the purchase agreement and registered with the Ministry of Justice of Georgia. It accrues from the purchase date, including during construction, independent of seasonality.",
  "project.video": "Video about the project",
